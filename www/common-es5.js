  ...
  function srcAppServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        ...
        key: "getEpisodesBySeries",
        value: function getEpisodesBySeries(serie) {
          return this.http.get("https://www.breakingbadapi.com/api/episodes?series=".concat(serie));
        }
      }, {
        key: "searchData",
        value: function searchData(find, type) {
          switch (type) {
            case "series":
              {
        ...
        key: "getCharactersByCategories",
        value: function getCharactersByCategories(category) {
          return this.http.get("https://www.breakingbadapi.com/api/characters?category=".concat(category));
        }
      }, {
        key: "getCharactersByRandom",
        value: function getCharactersByRandom() {
          return this.http.get("https://breakingbadapi.com/api/characters/random");
        }
      }, {
        key: "getCharactersByName",
        value: function getCharactersByName(name) {
          return this.http.get("https://www.breakingbadapi.com/api/characters/?name=".concat(name));
        }
      }, {
        key: "searchDataCharacter",
        value: function searchDataCharacter(find, type) {
          switch (type) {
            case "category":
              {
        ...
        key: "getQuotesByRandom",
        value: function getQuotesByRandom() {
          return this.http.get("https://breakingbadapi.com/api/quote/random");
        }
      }, {
        key: "getQuotesByRandomAuthor",
        value: function getQuotesByRandomAuthor(author) {
          return this.http.get("https://www.breakingbadapi.com/api//quote/random?author=".concat(author));
        }
      }, {
        key: "searchDataQuote",
        value: function searchDataQuote(find, type) {
          switch (type) {
            case "author":
              {
        ...
        key: "getDeathsByName",
        value: function getDeathsByName(name) {
          return this.http.get("https://www.breakingbadapi.com/api/death-count?name=".concat(name));
        }
      }, {
        key: "getDeathsByRandom",
        value: function getDeathsByRandom() {
          return this.http.get("https://breakingbadapi.com/api/random-death");
        }
      }, {
        key: "getDeathsByCount",
        value: function getDeathsByCount() {
          return this.http.get("https://breakingbadapi.com/api/death-count");
        }
      }, {
        key: "getDeathPages",
        value: function getDeathPages(limit, offset) {
          return this.http.get("https://www.breakingbadapi.com/api/deaths?limit=".concat(limit, "&offset=").concat(offset));
        }
      }, {
        key: "searchDataDeath",
        value: function searchDataDeath(find, type) {
          switch (type) {
            case "name":
              {
